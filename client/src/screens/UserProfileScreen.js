...
const UserProfileScreen = () => {
    ...
    return (
        <Fragment>
            ...
            {tab === 'sale' && (
                <Fragment>
                    {isSuccess && data.saleGames.length === 0 && (
                        <CustomAlert severity='warning'>No games found</CustomAlert>
                    )}
            ...
            {tab === 'trade' && (
                <Fragment>
                    {isSuccess && data.tradeGames.length === 0 && (
                        <CustomAlert severity='warning'>No games found</CustomAlert>
                    )}
                    <Grid container spacing={3}>
                        {isSuccess &&
            ...
            {tab === 'wanted' && (
                <Fragment>
                    {isSuccess && data.wantedGames.length === 0 && (
                        <CustomAlert severity='warning'>No games found</CustomAlert>
                    )}
