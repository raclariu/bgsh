                ...
                <Fragment>
                    {data.mode === 'sell' && (
                        <Helmet
                            ...
                            description={
                                data.isPack
                                    ? `I am selling a pack of ${data.games.length} boardgames - For more details go to https://meeples.ro/sales/${data.altId}`
                                    : `I am selling ${data.games[0].title} - For more details go to https://meeples.ro/sales/${data.altId}`
                            }
                    ...
                    {data.mode === 'trade' && (
                        <Helmet
                            ...
                            description={
                                data.isPack
                                    ? `I am trading a pack of ${data.games.length} boardgames - For more details go to https://meeples.ro/trades/${data.altId}`
                                    : `I am trading ${data.games[0].title} - For more details go to https://meeples.ro/trades/${data.altId}`
                            }
                            img={data.games[idx].thumbnail}
                        />
                    )}
                    ...
                    {data.mode === 'want' && (
                        <Helmet
                            title={data.games[idx].title}
                            description={`I am looking to buy ${data.games[0].title} -  For more details go to https://meeples.ro/wanted/${data.altId}`}
                            img={data.games[idx].thumbnail}
                        />
                    )}
                </Fragment>
                ...
                <Fragment>
                    ...
                    <Box role='presentation' mb={2}>
                        <Breadcrumbs separator='/' aria-label='breadcrumb'>
                            <Link
                                ...
                                underline='hover'
                                color='inherit'
                                to={`/${data.slug.split('/')[1]}`}
                            >
                                {data.slug.split('/')[1].charAt(0).toUpperCase() + data.slug.split('/')[1].slice(1)}
                            </Link>
                            <Box color='text.primary'>{data.games[idx].title}</Box>
                        </Breadcrumbs>
                    </Box>
                    ...
                    >
                        <Box
                            ...
                            borderRadius='4px'
                        >
                            <Zoom zoomMargin={16} overlayBgColorStart='rgba(0,0,0,0)' overlayBgColorEnd='rgba(0,0,0,0.5)'>
                                <StyledCoverImg
                        ...
                        >
                            ...
                            <Box fontSize='caption.fontSize' color='text.secondary'>
                                {`${data.mode === 'sell' ? 'for sale' : data.mode === 'trade' ? 'for trade' : 'wanted'} • ${
                                    data.games[idx].subtype
                                } • ${data.games[idx].year}`}
                            </Box>
                            ...
                            <Box display='flex' alignItems='center'>
                                ...
                                <Box ml={0.5} fontSize='caption.fontSize'>
                                    {data.games[idx].designers.length > 0 ? data.games[idx].designers.join(', ') : 'N/A'}
                                </Box>
                            </Box>
                            ...
                            >
                                <Box display='flex' alignItems='center' gap={1}>
                                    ...
                                    <ExtLinkIconBtn url={`https://boardgamegeek.com/boardgame/${data.games[idx].bggId}`} />
                                    <SendMessage recipientUsername={data.addedBy.username} />
                                    {data.mode !== 'want' && <SaveGameButton altId={altId} addedById={data.addedBy._id} />}
                                </Box>
                                {data.mode === 'sell' && (
                    ...
                    {!Boolean(currUserId) && (
                        <Fragment>
                            <Box
                                ...
                                gap={2}
                            >
                                <Box textAlign='center'>To access all features, please log in or create an account</Box>
                    ...
                    <Box my={2}>
                        ...
                        >
                            ...
                            >
                                ...
                                {data.mode === 'want' && (
                                    <Box display='flex' gap={0.5} flexWrap='wrap'>
                                        ...
                                        <Chip
                                            size='small'
                                            color='primary'
                                            label={`prefer ${data.games[idx].prefVersion.title} • ${data.games[idx].prefVersion.year}`}
                                        />
                                    </Box>
                                )}
                                ...
                                {data.isPack && data.extraInfoPack && (
                                    <Box display='flex' flexDirection='column'>
                                    ...
                                    <Box display='flex' flexDirection='column'>
                                        ...
                                        <Box>
                                            <Collapse in={showMoreDescription} collapsedSize={50} timeout='auto'>
                                                <Box fontStyle='italic' color='text.secondary' fontSize='caption.fontSize'>
                                                    {data.games[idx].description
                                                        .split('&#10;')
                                                        .filter((part) => part.trim().length !== 0)
                                                        .map((txt, i) => (
                                                            <StyledParagraph key={i}>{parseEntities(txt)}</StyledParagraph>
                                                        ))}
                                                </Box>
                                            </Collapse>
                                        </Box>
                                        ...
                                        <Fragment>
                                            ...
                                            >
                                                {data.shipping.shipCourier ? (
                                                    ...
                                                    <Fragment>
                                                        <CancelRoundedIcon color='error' />
                                                        <Box textAlign='center'>Shipping by courier is not preferred</Box>
                                                    </Fragment>
                                                )}
                                            </Box>
                                        ...
                                        <Fragment>
                                            ...
                                            >
                                                {data.shipping.shipPost ? (
                                                    <Fragment>
                                                        <MarkunreadMailboxTwoToneIcon color='primary' />
                                                        <Box textAlign='center'>{`Shipping by post paid by ${
                                                            data.shipping.shipPostPayer === 'seller'
                                                                ? `${data.addedBy.username}`
                                                                : 'buyer'
                                                        }`}</Box>
                                                    </Fragment>
                                            ...
                                            >
                                                {data.shipping.shipCourier ? (
                                                    <Fragment>
                                                        <LocalShippingTwoToneIcon color='primary' />
                                                        <Box textAlign='center'>{`Shipping by courier paid by ${
                                                            data.shipping.shipPostPayer === 'seller'
                                                                ? `${data.addedBy.username}`
                                                                : 'buyer'
                                                        }`}</Box>
