...
const validateSocialsShow = check('show').isIn([true, false]).withMessage('Invalid socials display checkbox selection')

const validateLogin = [validateEmail, validatePasswordLogIn]
const validateSignUp = [validateEmailDuplicate, validateUsername, validatePasswordSignUp, validatePasswordConfirmation]
