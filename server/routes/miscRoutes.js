...
router
    .route('/report')
    .post([protect, validateReportType, validateReportText, validateReportUsername, validateReportGameAltId], submitReport)
...
router.route('/bgg/gallery').get(bggGetGallery)
router.route('/bgg/recommendations').get(getBggReccomendations)
router.route('/bgg/videos').get(getBggVideos)
